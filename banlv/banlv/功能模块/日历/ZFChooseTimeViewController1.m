...
#import "ZFChooseTimeViewController1.h"
...
@interface ZFChooseTimeViewController1 ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
- (NSArray*)weekdays
{
    ...
    if (_weekdays == nil) {
        ...
        _weekdays = [NSArray arrayWithObjects:[NSNull null],@"日", @"一", @"二", @"三", @"四", @"五", @"六", nil];
...
- (void)viewDidLoad {
    ...
    [flowLayout setItemSize:CGSizeMake(cellw - 4.5, cellw*5/4)];//设置cell的尺寸
    [flowLayout setScrollDirection:UICollectionViewScrollDirectionVertical];//设置其布局方向
    [flowLayout setHeaderReferenceSize:CGSizeMake(kDeviceWidth - 110, 30)];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.clickCount == 1) {
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            selectedCell.number.backgroundColor = [UIColor colorWithHexString:@"#1DBCBF"];
        });
    ...
    if (self.clickCount == 2) {
        ...
        cell.number.backgroundColor = [UIColor colorWithHexString:@"#1DBCBF"];
